<template>
    <svg class="wave-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 1500 500" width="100%" height="100%">
        <path
    ...
    <svg class="wave-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 1500 500" width="100%" height="100%">
        <path
